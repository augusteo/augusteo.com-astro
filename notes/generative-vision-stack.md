...
The Cityscapes mIoU benchmark itself is the throughline — the public, citable comparison published on Vision Banana's project page. The recurring scenario is "the zero-shot Cityscapes column on this chart," not a particular photograph; figures showing a single street-scene image are illustrative SVG drawings (drawn-not-evaluated), with figcaptions making the illustrative-vs-measured distinction explicit. (Per Gate 0 finding #4: the matrix backs aggregate benchmark numbers, not any specific same-image side-by-side, so the prose / figures must not invent a concrete reproducible photo run.)

- **Act 1 — the puzzle.** Discriminative segmentation is the standard recipe: build a strong encoder, attach a per-pixel head, read off categorical masks. SAM 3 is the most recent prompt-based segmentation foundation model in this lineage (2025-11-20); on the project-page Cityscapes mIoU chart, it scores 0.699. Posts 1 and 2 of this series explained how those encoders are built and wired into a multimodal agent.
- **Act 2 — the flip.** Vision Banana, instruction-tuned from Nano Banana Pro, scores 0.842 on the same chart — by *generating* the segmentation mask as an RGB image whose pixel colors are the class labels. The recipe: parameterize each task's output space as RGB, then prompt the generator to paint it. The paper reports zero-shot transfer numbers: 0.842 mIoU on Cityscapes (vs SAM 3 0.699 in the same chart's zero-shot column); δ₁ 0.882 on the project-page six-benchmark metric-depth chart (next-best is UniK3D at 0.823); 15.549° surface-normal MAE (next-best Lotus-2 at 16.558°). Note: Vision Banana's depth chart does **not** include either Depth Anything V2 or V3, so the post cannot claim "Vision Banana beats the Depth Anything line."
...
Throughline is **canonical-real**: every concrete number cites a public primary source (project page, named arxiv competitor papers). The Cityscapes evaluation protocol itself is a foundational reference.
...
| 8 | On the project-page Cityscapes mIoU chart (zero-shot transfer), Vision Banana scores 0.842; SAM 3 scores 0.699; X-Decoder 0.652; OpenSeeD 0.520; APE-D 0.478; SegMan-L (the lone Non-Zero-Shot bar) scores 0.442. | Project-page chart: "SegMan-L (Non Zero-Shot): 0.442 / APE-D: 0.478 / OpenSeeD: 0.520 / X-Decoder: 0.652 / SAM 3: 0.699 / Vision Banana: 0.842." | https://vision-banana.github.io/ (accessed 2026-05-02) | actively-evolving / 12-month bar / passes (re-verified post-Gate 0 finding #1; codex's value-inversion challenge was checked and rejected — see `## Codex research review`) |
| 9 | On the project-page metric-depth chart (six-benchmark δ₁ average), Vision Banana scores 0.882; UniK3D 0.823; MoGe-2 0.802; Depth Pro 0.715. **The chart does NOT include Depth Anything V2 or V3.** | Project-page chart: "Depth Pro: 0.715 / MoGe-2: 0.802 / UniK3D: 0.823 / Vision Banana: 0.882. Note: 'Vision Banana does not use camera intrinsics in training or inference.'" | https://vision-banana.github.io/ (accessed 2026-05-02) | actively-evolving / 12-month bar / passes |
| 10 | On the project-page surface-normals chart (three-benchmark mean angular error, lower better), Vision Banana scores 15.549°; Lotus-2 16.558°; DSINE 17.017°; StableNormal 17.168°; Marigold 19.606°. | Project-page chart: "Marigold: 19.606 / StableNormal: 17.168 / DSINE: 17.017 / Lotus-2: 16.558 / Vision Banana: 15.549." | https://vision-banana.github.io/ (accessed 2026-05-02) | actively-evolving / 12-month bar / passes |
...
| 14 | Nano Banana Pro (= Gemini 3 Pro Image) is Google's production image-generation model, released 2025-11-20. Rolled out via the Gemini app, Google AI Studio, and Vertex AI. | Article body of [blog.google/innovation-and-ai/products/nano-banana-pro/](https://blog.google/innovation-and-ai/products/nano-banana-pro/) (2025-11-20). The article body lists rollout via the Gemini app, Google AI Studio, and Vertex AI. (We are NOT citing the page's AI-generated summary, per Gate 0 finding #7.) | blog.google/innovation-and-ai/products/nano-banana-pro/ (2025-11-20); accessed 2026-05-02 | actively-evolving / 12-month bar / passes — pending body-text re-fetch to lock the exact wording (currently summarized; see `## Codex research review`) |
...
| 23 | Depth Anything V3 was released 2025-11-13. Vision Banana's project-page depth chart does **not** include either DAv2 or DA3 — its baselines are Depth Pro, MoGe-2, UniK3D. The post must not claim Vision Banana beats the Depth Anything line; it can claim Vision Banana beats the project-page-listed depth baselines. | "Depth Anything 3… outperforming its predecessor (DA2) in monocular depth estimation." | arxiv:2511.10647 (2025-11-13); accessed 2026-05-02 | actively-evolving / 12-month bar / passes (per Gate 0 finding #3) |
...
| 26 | Depth competitors named on the Vision Banana project-page chart: Depth Pro, MoGe-2, UniK3D. Each is a published primary monocular-depth method as of pubDate. | Project-page chart values (see row 9). Per-paper primaries: Depth Pro (Bochkovskii et al., Apple, arxiv:2410.02073, 2024-10-02); MoGe-2 (Wang et al., Microsoft, arxiv:2509.02866, 2025-09-03); UniK3D (Piccinelli et al., ETH/Politecnico di Milano, arxiv:2503.16591, 2025-03-20). | arxiv:2410.02073 + arxiv:2509.02866 + arxiv:2503.16591 (accessed 2026-05-02) | mixed: MoGe-2 + UniK3D in-bar; Depth Pro is 19 months at pubDate, treat as foundational competitor reference (the comparison baseline on the project page) |
| 27 | Surface-normal competitors named on the Vision Banana project-page chart: Marigold (19.606°), StableNormal (17.168°), DSINE (17.017°), Lotus-2 (16.558°). | Project-page chart values (see row 10). Per-paper primaries: Marigold (Ke et al., arxiv:2312.02145, 2023-12-04); StableNormal (Ye et al., arxiv:2406.16864, 2024-06-24); DSINE (Bae & Davison, arxiv:2403.00712, 2024-03-01). | arxiv:2312.02145 + arxiv:2406.16864 + arxiv:2403.00712 (accessed 2026-05-02) | mixed: StableNormal in-bar; DSINE is 14 months (marginal — annotated as 14-month-near-bar competitor reference); Marigold is foundational competitor reference at 29 months |
...
**Disagreement on finding #1 (recorded per codex skill rule).** Codex's text was: "The project page lists Cityscapes values as `0.842, 0.442, 0.478, 0.520, 0.652, 0.699` against `SegMan-L (Non Zero-Shot), APE-D, OpenSeeD, X-Decoder, SAM 3, Vision Banana`." Re-fetched the project page directly: the actual chart shows `SegMan-L (Non Zero-Shot): 0.442 / APE-D: 0.478 / OpenSeeD: 0.520 / X-Decoder: 0.652 / SAM 3: 0.699 / Vision Banana: 0.842.` Codex got the model order right but inverted the bar values — likely due to ambiguous chart-axis ordering when read via web search rather than direct render. Original matrix row 8 was correct. Rebuilt the row to enumerate every bar (zero-shot + the lone non-zero-shot SegMan-L baseline) so subsequent passes have an unambiguous reading. This rejection is recorded here so a future agent does not silently reverse the value on resume.
...
|---|---|---|---|
| 2026-05-02 | 0 (research) — run 1 | structural-fixes-applied (6 of 7 STRUCTURAL accepted; 1 rejected on re-fetch with recorded reasoning); 2 COSMETIC accepted/acknowledged. Gate-runner re-run pending. | [notes/generative-vision-stack-codex-research-20260502.md](generative-vision-stack-codex-research-20260502.md) + `## Codex research review` summary in this file |
