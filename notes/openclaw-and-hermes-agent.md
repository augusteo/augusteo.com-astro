...
| 37 | Hermes's Skills Hub is compatible with the agentskills.io open standard (originally developed by Anthropic; released as an open standard; adopted by **multiple** AI agent products — specific adopter count NOT primary-backed in agentskills.io spec or Hermes docs; Run 1 codex finding dropped the "30+" number). | Hermes README: "Compatible with the agentskills.io open standard." agentskills.io/specification: "The Agent Skills format was originally developed by Anthropic, released as an open standard, and has been adopted by a growing number of agent products." (Note: agentskills.io/clients exists but does not enumerate to a specific count of 30+ in the published spec.) | github.com/NousResearch/hermes-agent/blob/v2026.5.7/README.md; agentskills.io/specification accessed 2026-05-08; agentskills.io/clients accessed 2026-05-08 | passes — count claim removed; Anthropic-origin and open-standard claims primary-backed |
...
**Gate 0 Run 1 (2026-05-08).** Codex consult fired against Spec + Throughline + Research notes + 43-row Claim-source matrix. **Findings: 6 STRUCTURAL, 1 COSMETIC.** Codex did not find any stale rows (every dated source within the 2025-05-08 12-month bar) and did not find fabricated quotes; the issues were attribution-discipline issues. Findings (truncated; see findings file for verbatim): row 14 was Star-History laundering; row 31 overstated the Honcho dependency (Honcho is an optional extra, not core); row 37 had unsupported "30+ adopters" count; row 39 falsely placed native Windows in v0.13.0; row 24 was a verdict not a claim-source mapping; Act 1 promised author-constructed failure-case examples that should be annotated as such. All 6 STRUCTURAL fixes applied to the matrix and throughline; Run 2 pending. **Findings: 6 STRUCTURAL, 1 COSMETIC.**

[full findings: notes/openclaw-and-hermes-agent-codex-research-20260508.md]
...
| 2026-05-08 | 0 Run 1 (research) | 6 STRUCTURAL + 1 COSMETIC; structural fixes applied; Run 2 pending | `notes/openclaw-and-hermes-agent-codex-research-20260508.md` |
