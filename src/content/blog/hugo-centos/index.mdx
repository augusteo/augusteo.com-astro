...
description: "How to Host Static Websites Like Hugo on CentOS VPS with Nginx - Tutorial Part 1 - a blog post by Victor Augusteo"
pubDate: 2016-08-06
heroImage: "@assets/blog/hugo-centos/hugo-centos-Screenshot_2016-08-07_12_17_59.jpg"
heroAlt: "hugo centos Screenshot 2016 08 07 12 17 59"
tags: ["Tech"]
featured: false
draft: false
---

Last time, we have learned how to [get started with Hugo](https://hugo.augusteo.com/super-quick-guide-to-start-using-hugo/) and run the server on our local machine. That alone is fun, but our friends couldn’t check it out. What’s the use of a blog if only you can read it? The blog need to be served on the internet through a domain name so people can read it easily.
...
We will be using [Vultr](http://www.vultr.com/?ref=6933377-3B) to host our VPS. Why Vultr? I came highly recommended from my friend [Curtis over at CentOS Blog](https://www.centosblog.com/author/curtis/). He is the devops guy at PwC and we used to work together, so I know to just trust his words on server stuff. Who better to ask from than the guy who play with server all day long?

Plus if you register to [Vultr](http://www.vultr.com/?ref=6933377-3B) with this link, you will get $20 free credit that you can use to spin up server for free!

# Creating account and spinning up VPS on Vultr

So lets over to [Vultr](http://www.vultr.com/?ref=6933377-3B) and create a new account if you haven’t already. It is pretty straightforward and should be pretty standard account creation process.

After you are done, please log in. You should see this screen:

![hugo-centos-Screenshot_2016-08-07_12_17_59.jpg](@assets/blog/hugo-centos/hugo-centos-Screenshot_2016-08-07_12_17_59.jpg)
...
Let’s login to your domain registrar management page. The example shown is specific to [CrazyDomain](https://www.crazydomains.com.au/) as it is where I register my .xyz domain name, but it will be easily applicable to any other registrar.

Find the option to change/edit your domain’s nameserver:

![hugo-centos-Account_Manager.jpg](@assets/blog/hugo-centos/hugo-centos-Account_Manager.jpg)
...
Now lets get back to [Vultr](http://www.vultr.com/?ref=6933377-3B) management page and select `DNS` on the top menu bar.

![hugo-centos-DNS_-_Vultr_com.jpg](@assets/blog/hugo-centos/hugo-centos-DNS_-_Vultr_com.jpg)
