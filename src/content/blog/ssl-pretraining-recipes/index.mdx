...
{/* TODO: Fig 12: OODEvidenceSummary, domains (satellite, medical, document-layout, construction-drawings) × strategies (zero-shot natural-image init / continual SSL on natural / from-scratch SSL on domain) grid. Cells filled with the best published delta + paper, or labeled "absent" / blank for absent. The construction-drawings row is mostly absent cells. Caption explicitly disclaims cross-domain comparison and notes the construction-drawings row is what motivated this post. */}
