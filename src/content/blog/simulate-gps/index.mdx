...
description: "How To Simulate GPS Movement in iOS - a blog post by Victor Augusteo"
pubDate: 2016-07-10
heroImage: "@assets/blog/simulate-gps/simulate-gps-Screen-Shot-2016-07-10-at-5.51.59-PM.png"
heroAlt: "simulate gps Screen Shot 2016 07 10 at 5.51.59 PM"
tags: ["Tech"]
featured: false
draft: false
---
...
– very basic iOS development experience
 ...
 – text editor with regex find and replace function, such as [Sublime Text](https://www.sublimetext.com/)
...
Lets visit this website first: [GPSies track creator](http://www.gpsies.com/createTrack.do)
...
![simulate-gps-Screen-Shot-2016-07-10-at-5.51.59-PM.png](@assets/blog/simulate-gps/simulate-gps-Screen-Shot-2016-07-10-at-5.51.59-PM.png)
...
![simulate-gps-Screen-Shot-2016-07-10-at-5.58.59-PM.png](@assets/blog/simulate-gps/simulate-gps-Screen-Shot-2016-07-10-at-5.58.59-PM.png)

After we are done with drawing tracks, scroll down and find the `Export file` section and press `download`

![simulate-gps-Screen-Shot-2016-07-10-at-6.01.21-PM.png](@assets/blog/simulate-gps/simulate-gps-Screen-Shot-2016-07-10-at-6.01.21-PM.png)
...
![simulate-gps-Screen-Shot-2016-07-10-at-6.27.54-PM-1024x136.png](@assets/blog/simulate-gps/simulate-gps-Screen-Shot-2016-07-10-at-6.27.54-PM-1024x136.png)
...
Now the third point is tricky. We can’t just run a new empty app as iOS will kill it after several minutes of no activity to save battery and memory. We have to force it to keep running by using this trick:**keep requesting location update in the background**
...
![simulate-gps-Screen-Shot-2016-07-10-at-6.55.21-PM-1024x397.png](@assets/blog/simulate-gps/simulate-gps-Screen-Shot-2016-07-10-at-6.55.21-PM-1024x397.png)

## Info.plist

Open the `Info.plist` on the project navigator and add these two keys in the plist:

![simulate-gps-Screen-Shot-2016-07-10-at-7.00.26-PM-1024x77.png](@assets/blog/simulate-gps/simulate-gps-Screen-Shot-2016-07-10-at-7.00.26-PM-1024x77.png)
...
If it doesn’t ask you for permission, just go to`Settings -> Privacy -> Location Services -> 'your app name' -> Always`
...
![simulate-gps-Screen-Shot-2016-07-10-at-7.31.57-PM.png](@assets/blog/simulate-gps/simulate-gps-Screen-Shot-2016-07-10-at-7.31.57-PM.png)
