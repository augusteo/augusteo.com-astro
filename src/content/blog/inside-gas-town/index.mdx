...
The job of an orchestrator (which is what Gas Town is) is to fix the medium. Make the trail durable, make the work survive the session, let multiple agents pass the work between them without losing what's on it. Once you accept that as the goal, almost everything else in Gas Town's design follows.
...
The first is that the issues are *in the repo*. Your branch and your work tracker move together. When you check out an old commit, the issue tracker rewinds to match. When you fork a branch to try something out, the work plan forks with it. Git's whole vocabulary for managing parallel work (branches, merges, rebases, cherry-picks) applies to your tickets the same way it applies to your code. This sounds small. It is not. It means an AI agent reading your repo has access to the full work history without any extra API call.
...
There's parallel academic work pointing in the same direction. The [MAKER paper](https://arxiv.org/abs/2511.09030) from Cognizant and UT Austin (Nov 2025) showed you can complete an LLM task with over a million dependent steps and zero errors, by decomposing the task into atomic microagents and applying per-step error correction. NDI is a less clinical version of the same insight: long LLM workflows complete reliably when each step is atomized, well-specified, and individually checkable. Gas Town adds the working substrate and the role hierarchy on top.
...
**The Deacon** is the watchdog. It runs a patrol loop, every couple of minutes, checking on the health of the town. It can dispatch maintenance work, restart stuck agents, escalate genuine problems to you. The Deacon is what makes Gas Town keep running while you're at lunch. (It is also, in early Gas Town versions, the role most likely to go feral. Yegge had to issue a public warning during the first month asking users to disable the Deacon because it was, in his words, ["spree-killing all the other workers while on his patrol."](https://steve-yegge.medium.com/gas-town-from-clown-show-to-v1-0-c239d9a407ec) This has since been fixed.)
...
<svg viewBox="0 0 760 200" xmlns="http://www.w3.org/2000/svg" width="100%" font-family="serif" role="img" aria-label="Timeline of the Beads/Gas Town/Gas City stack from October 2025 to April 2026.">
  ...
  <g transform="translate(665,100)">
    <circle cx="-15" cy="0" r="6" fill="#fdfbf6" stroke="#1c1a15" stroke-width="1.8"/>
    <line x1="-15" y1="6" x2="-15" y2="22" stroke="#1c1a15" stroke-width="1"/>
    <text x="-15" y="36" text-anchor="middle" font-weight="600" font-size="11">Beads + GT v1.0</text>
    <text x="-15" y="52" text-anchor="middle" font-size="11" fill="#3a342a">Dolt migration done</text>
    <text x="-15" y="-14" text-anchor="middle" font-size="10" fill="#8a8377" letter-spacing="0.05em">APR 21</text>

    <circle cx="35" cy="0" r="7" fill="#b8543e" stroke="#1c1a15" stroke-width="1.8"/>
    <line x1="35" y1="-7" x2="35" y2="-22" stroke="#1c1a15" stroke-width="1"/>
    <text x="35" y="-32" text-anchor="middle" font-weight="600" font-size="12">Gas City</text>
    <text x="35" y="22" text-anchor="middle" font-size="10" fill="#8a8377" letter-spacing="0.05em">APR 24, 2026</text>

    <path d="M-30,68 Q10,76 50,68" fill="none" stroke="#b8543e" stroke-width="1" opacity="0.6"/>
    <text x="10" y="86" text-anchor="middle" font-style="italic" font-size="10" fill="#b8543e">3 days apart</text>
  </g>
...
> **The 11 stages of AI-assisted coding.**
>
> Yegge's adoption framework, originally 8 stages at Gas Town launch, extended to 11 with Gas City. Locate yourself before deciding what to install.
>
> **1.** Zero-AI · **2.** IDE agent, permissions on · **3.** IDE agent, YOLO · **4.** IDE wide-agent · **5.** CLI single-agent, YOLO · **6.** CLI multi-agent (3–5) · **7.** 10+ agents, hand-managed · **8.** Building your own orchestrator · **9.** First deployed pack (a real business process) · **10.** Many deployed packs (you become the bottleneck) · **11.** Factory builder (a meta-orchestrator manages your packs).
>
> Yegge's blunt advice: Stage 7+ to use Gas Town safely. Stage 5–6 should not install it. Stage 1–4 should not even read about it.
