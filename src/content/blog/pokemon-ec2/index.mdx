...
description: "How To Run Pokemon Go Bot On The Cloud With AWS EC2 - a blog post by Victor Augusteo"
pubDate: 2016-07-26
heroImage: "@assets/blog/pokemon-ec2/pokemon-ec2-ec2img.jpg"
heroAlt: "pokemon ec2 ec2img"
tags: ["Tech"]
featured: false
draft: false
---
...
The most popular PoGo bot right now is the [Necro Bot](https://github.com/NecronomiconCoding/NecroBot). It only runs on windows so those of you who doesn’t have a Windows machine are kind of screwed.
...
3. Run it on VPS such as [AWS EC2](https://aws.amazon.com/ec2/) which runs all the time, accessible everywhere and very affordable (even free!)
...
This guide is mostly for people who wants to run the bot on AWS EC2. It is totally fine to run it on your windows machine if you didn’t want to bother with AWS. Just go to the [NecroBot wiki](https://github.com/NecronomiconCoding/NecroBot/wiki/Compiled-Releases) and follow the instruction there.
...
So please head to [AWS website](https://aws.amazon.com/) to register or login.

# Launching EC2

Once you inside the console, please click on Services -> EC2 on the menu at the top.

![pokemon-ec2-ec2img.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-ec2img.jpg)

Let’s press the `Launch Instance` button to start. Scroll down until you see the one called:

`Microsoft Windows Server 2012 R2 Base`

![pokemon-ec2-ec2windowsimg.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-ec2windowsimg.jpg)

And click on `Select`.

On the next screen, let’s go with the free tier one. Then please press `Review and Launch`

![pokemon-ec2-ec2freeimg.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-ec2freeimg.jpg)

Then just press `Launch` when you are ready.

When prompted for `key pair`, select `Create a new key pair` and give it a memorable name, such as `myKey`. Download the key and press `Launch Instance`

![pokemon-ec2-ec2keyimg.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-ec2keyimg.jpg)
...
![pokemon-ec2-ec2list.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-ec2list.jpg)
...
If you are on a mac, you will have to download the app [Microsoft Remote Desktop](https://itunes.apple.com/au/app/microsoft-remote-desktop/id715768417?mt=12) from the Mac App Store.

On windows, you should have the `Remote Desktop Connection` app installed already.

Now please run the `.rdp` file that you downloaded on the previous step. It should run the RDP app and logs you into the server. Enter the password you get before and you are ready to proceed!
...
Now let’s go to the [NecroBot Installation Wiki](https://github.com/NecronomiconCoding/NecroBot/wiki/Compiled-Releases) and read the instructions. When you understand what to do, lets click on the `Release.zip` link.
...
![pokemon-ec2-internetoptions.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-internetoptions.jpg)
...
![pokemon-ec2-enabledownload.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-enabledownload.jpg)

Now try to download the file again and you should be able to. Once it is done, just click on `Open Folder`

There you have it, the bot is extracted and ready to be configured. Just follow the steps outlined in the [NecroBot wiki](https://github.com/NecronomiconCoding/NecroBot/wiki/Compiled-Releases) and you should be on your way to leveling up!

![pokemon-ec2-bot.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-bot.jpg)
...
![pokemon-ec2-multiple.jpg](@assets/blog/pokemon-ec2/pokemon-ec2-multiple.jpg)
