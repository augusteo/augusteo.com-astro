...
description: "Binary Search Algorith with Recursion and Generics - Swift Tutorial - a blog post by Victor Augusteo"
pubDate: 2016-08-26
heroAlt: "Binary Search Algorith with Recursion and Generics - Swift Tutorial"
tags: ["Tech"]
featured: false
draft: false
---

Following through with my [last post](https://hugo.augusteo.com/swift-quick-sort-algorithm-with-recursion-and-generic), we will explore how to implement the [binary search](https://www.khanacademy.org/computing/computer-science/algorithms/binary-search/a/implementing-binary-search-of-an-array) algorithm in Swift. Of course it has to be generic too!

# Problem and assumption

This algorithm assumes that we have an array of comparable objects. That is to say, the compiler should know how to compare those objects. If your object is not a primitive type, then you can follow the [last post](https://hugo.augusteo.com/swift-quick-sort-algorithm-with-recursion-and-generic) on how to make the struct/class/enum conform to `Comparable` protocol.
