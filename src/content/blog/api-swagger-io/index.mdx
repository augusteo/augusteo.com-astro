...
![Swagger.io](https://miro.medium.com/max/1400/1*FiejaxmxNLxFe33vFpsu5g.jpeg)
...
```ruby
helloName = params[:name].to_s
{"message" => "Hello #{helloName}"}.to_json
```
...
```ruby
firstNum = params[:first].to_i
secondNum = params[:second].to_i
sum = firstNum + secondNum
{"message" => "The sum of #{firstNum} and #{secondNum} is #{sum}"}.to_json
```
...
![Project structure after pod install](https://miro.medium.com/max/1016/1*o11XF3cwo96LhT182uDKYg.png)
